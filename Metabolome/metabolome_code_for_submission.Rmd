...
```{r,fig.height=6,eval=FALSE}
mysamps = c(mdm2hiTreated_samps,mdm2_low_treated_samps,mdm2hi,mdm2lo)
  categ = c(mycateg[mdm2hiTreated],mycateg[mdm2loTreated],mycateg[mdm2hi],mycateg[mdm2lo])
  status = c(rep("Treated",length(mdm2hiTreated_samps)+length(mdm2_low_treated_samps)),rep("Untreated",length(mdm2lo)+length(mdm2lo)))
